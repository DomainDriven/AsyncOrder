 ...
 */
public class InventoryBusinessActivity implements AsyncBusinessActivity<SalesOrder, Boolean> {
    private final String id = java.util.UUID.randomUUID().toString().toUpperCase();

    @Override
    public void perform(SalesOrder order, Callback<Boolean> callback) {
